...
protected:
    ...
    //Walls, hallways, explored areas
    const int WALL = 0;
    const int HALLWAY = 1;

    const int PATH = 3;
    int maze_grid[5][5][5] = {0}; // To hold values
    int original_maze_grid[5][5][5] = {0};
...
public:
    ...
    */
    bool importMaze(string) override;
    //-----------------------------------------------------------------------------------------
    ...
    */
    bool find_maze_path(int[X][Y][Z], int, int, int);
